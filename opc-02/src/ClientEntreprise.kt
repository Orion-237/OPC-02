class ClientEntreprise (nomClient: String?, numeroCompteur: Int?, consommation : Double?): Client(nomClient,numeroCompteur,consommation) {

    //taux en fonction du type de client
    override var tauxParKwh = 40.0
